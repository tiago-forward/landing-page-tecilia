  ...
  return (
    <main>
      <section id="home" className="min-h-[90vh] backgroundGrandientHero">
        ...
        <div className="max-w-6xl mx-auto min-h-[90vh] px-4 pt-24 md:pt-32 lg:pt-40 relative">
          <div className="flex flex-col items-center justify-center gap-8 lg:flex-row relative mt-10 md:mt-20">
            ...
            <div className="flex flex-col md:gap-10 items-center justify-center mt-24 lg:mt-0 text-center">
              ...
              <p className="text-txt-description font-semibold text-lg md:text-2xl lg:text-3xl tracking-wide max-w-md sm:max-w-xl lg:max-w-2xl">
      ...
      <section id="serviços" className="min-h-[79vh] bg-[#E5DAA6]">
        <Services />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            fill="#E4E5E7"
      ...
      <section id="contato" className="min-h-[79vh] bg-[#E5DAA6]">
        <Contact />
      </section>
    </main>
  );

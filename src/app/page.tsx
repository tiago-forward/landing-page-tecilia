...
export default function Home() {
  return (
    <main>
      <section id="home" className="bg-white text-[#623E1B]">
        {/* <div
        ...
        <div className="max-w-6xl mx-auto px-4 relative">
          <div className="flex flex-col items-center justify-center gap-8 lg:flex-row relative">
            ...
            <div className="flex flex-col md:gap-10 items-center justify-center mt-24 lg:mt-0 text-center">
              ...
              <p className="font-actioness font-semibold text-lg md:text-2xl lg:text-3xl tracking-wide max-w-md sm:max-w-xl lg:max-w-2xl">
      ...
      {/* Seções subsequentes */}
      <section id="sobre" className="pt-20 min-h-[79vh] bg-[#E0BE14]">
        <About />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            fill="#FFFFFF"
      ...
      <section id="serviços" className="min-h-[79vh] bg-[#FFFFFF]">
        <Services />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            fill="#E0BE14"
      ...
      <section id="depoimentos" className="min-h-[79vh] bg-[#E0BE14]">
        <Testimonials />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            fill="#FFFFFF"
